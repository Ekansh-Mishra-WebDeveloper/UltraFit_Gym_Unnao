...
(function() {
  ...
  if (trialForm) trialForm.addEventListener('submit', submitTrialForm);
  ...
  const floatingTrialBtn = document.getElementById('floatingTrialBtn');
  if (heroVipBtn) heroVipBtn.addEventListener('click', openLeadModal);
  if (floatingTrialBtn) floatingTrialBtn.addEventListener('click', openLeadModal);
